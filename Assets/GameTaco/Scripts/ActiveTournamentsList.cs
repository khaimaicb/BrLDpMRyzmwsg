...
namespace GameTaco {
	public class ActiveTournamentsList : BaseListBehavior {
		
		public static ActiveTournamentsList Instance;
		...
		protected override void Start() {
			...
			ColumnNames = TacoConfig.CurrentTournamentsColumns;
		...
		public void Reload(List<Tournament> tournaments, List<Tournament> endedList)
        {

...
namespace GameTaco {
	public class PrivateTournamentsList : BaseListBehavior {
		...
		protected override void Start() {
			...
			ColumnNames = TacoConfig.PrivateTournamentsColumns;
			...
			var column4 = ( adjustedWidth * 0.15f);//* 0.95f;
		...
		public void CreateSubObjects(ListViewItem item, Tournament t) {
			...
			if(t!=null){
				...
				SelectedPreFabToDestroy = GameObject.Instantiate (this.ItemShowLeaderboardPrefab) as GameObject;
					...
					SelectedPreFabToDestroy = GameObject.Instantiate (this.ItemInvitePrefab) as GameObject;
				}
				selectedSubItem.CustomControl = SelectedPreFabToDestroy.transform as RectTransform;
			}
		}
